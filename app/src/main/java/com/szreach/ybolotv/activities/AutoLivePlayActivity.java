...
public class AutoLivePlayActivity extends Activity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        progressDialog = UIUtils.createDialog(AutoLivePlayActivity.this);
        progressDialog.setCancelable(true);

        String liveRtmpAddress = getIntent().getStringExtra("livePath");
        playLive(liveRtmpAddress);
    }

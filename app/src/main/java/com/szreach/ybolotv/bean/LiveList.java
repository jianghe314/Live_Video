...
public class LiveList {
    ...
    @Generated(hash = 1821182255)
    public LiveList(long coId, String channelId, String channelName, String rtmpPush, String rtmpHsPush, int channelFlag, String ln01,
                    String ln02, String ln03, String hn01, String hn02, String hn03, int ls01, int ls02, int ls03, int hs01, int hs02, int hs03,
                    String ln04, String ln05, String ln06, String hn04, String hn05, String hn06, int ls04, int ls05, int ls06, int hs04, int hs05,
                    int hs06, String ln07, int ls07, String ln11, String hn11, String ln17, int l1, int l2, int liveMovie, int liveRes, int resNum,
                    int movieSd, int movieHd, int resSd, int resHd, int streamType, String rtmpAddress, String hlsAddress, String liveId,
                    String liveName, String liveStart, String liveEnd, int liveLevel, String livePass, int liveFlag, int commReview, String loId,
                    String voId, String qnId, int onLine, String payType, double payMoney, String templatePc, String templateMb, String liveRemark,
                    String cfgBackgroundImg1, String cfgType, int isConfig, String title, String item1, String item2, String item3, String item4,
                    String item5, String item6, String item7, String item8, String item9, String item10, int autoReply, String replyName,
                    String replyContent, String recordId, int recordStatus, String userId, String userName, int voiceCount, int likeCount,
                    String headImg, int onlineCount, int liveType, int channelStatus, int authFlag, String payTypeStr, String phoneValidate) {
        this.coId = coId;

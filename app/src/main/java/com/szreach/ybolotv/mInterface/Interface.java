...
public class Interface {
    ...
    public static String Login(){
        String url=getIpAddress(App.getApplication())+URL_PREFIX_MY_HOME+LOGIN;
        return url;
    }

    //首页直播列表
    public static String LiveList(){
        String url=getIpAddress(App.getApplication())+URL_PREFIX_LIVE+URL_POST_LIVE_LIST;
        return url;
    }

    //首页视频列表接口
    public static String VideoList(){
        String url=getIpAddress(App.getApplication())+URL_PREFIX_VIDEO+URL_POST_VIDEO_LIST_NOGROUP;
        return url;
    }
}
